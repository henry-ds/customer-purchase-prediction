...
## Dataset
The dataset used in this project is the *Customer Personality Analysis dataset*, which contains information on customer demographics, purchasing behavior, and campaign responses.
